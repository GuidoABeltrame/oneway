...
define('DB_NAME', 'springmemories');     // el nombre de la base de datos
define('DB_USER', 'springmemories');     // tu nombre de usuario de MySQL
define('DB_PASSWORD', 'Fatima01'); // ...y tu contraseña
define('DB_HOST', 'db4free.net');     // hay un 99% de probabilidades de que no necesites cambiar esto
