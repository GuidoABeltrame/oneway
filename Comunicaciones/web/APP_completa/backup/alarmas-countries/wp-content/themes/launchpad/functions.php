...
$options = array (
	...
	array(	"name" => "Dirección de Feedburner",
			"id" => $shortname."_feedburner_address",
			"std" => "",
			"type" => "text"),
	
	array(	"name" => "ID de Feedburner",
...
function mytheme_add_admin() {
    ...
    add_theme_page($themename." Opciones", "Opciones de Launchpad", 'edit_themes', basename(__FILE__), 'mytheme_admin');
