...
== DESIGN FILES ==
	...
	launchpad.zip [CONTAINS:]
		screenshot.png		style.css		ie.css		index.php		/images/ [SUBFOLDER]
			bar.gif			rss-icon.gif		functions.php
		readme.txt
