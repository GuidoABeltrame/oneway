<?php get_header(); ?>
	<div id="featured"><h3>Archivo &raquo;<?php wp_title(''); ?></h3></div>
	        ...
	        <div class="post">
				...
				<div class="clear"></div>
	                ...
	                <div class="entry-meta">
			        	...
			        	<img src="<?php bloginfo('stylesheet_directory'); ?>/images/category.png" alt="categories" /> Categories: <?php the_category(',') ?>
