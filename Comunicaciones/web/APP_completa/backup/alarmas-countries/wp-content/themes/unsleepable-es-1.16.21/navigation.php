	...
	*/ ?>
	...
	<div class="navigation">
		<div class="left"><?php next_posts_link('<span>&laquo;</span> Art&iacute;culos anteriores') ?></div>
		<div class="right"><?php previous_posts_link('Art&iacute;culos siguientes <span>&raquo;</span>') ?></div>
		<div class="clear"></div>
	</div>
