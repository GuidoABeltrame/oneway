...
function liveSearchProcessReqChange() {
	...
	if (liveSearchReq.readyState == 4) {
		...
		res.firstChild.innerHTML = '<div id="searchcontrols"><small>Teclas de direcci&oacute;n, ingresar y <a href="javascript://" title="Cerrar resultados" onclick="closeResults()">escape</a></small><br /></div>'+liveSearchReq.responseText;
	}
