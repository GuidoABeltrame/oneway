...
if ( empty($post_status) ) {
	...
	fail('El art&iacute;culo en el que intentas comentar actualmente no existe.');
} elseif ( 'closed' ==  $post_status ) {
	do_action('comment_closed', $comment_post_ID);
	fail(__('Lo siento, los comentarios a este art&iacute;culo est&aacute;n cerrados.'));
}
