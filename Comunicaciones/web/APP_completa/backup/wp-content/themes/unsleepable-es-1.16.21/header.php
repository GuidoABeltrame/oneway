...
<head profile="http://gmpg.org/xfn/11">
	...
	<title><?php wp_title(''); ?> <?php if ( !(is_404()) && (is_single()) or (is_page()) or (is_archive()) ) { ?> en <?php } ?> <?php bloginfo('name'); ?></title>
...
<div id="page">
	...
	<div id="header">
            ...
            <div id="title"><a href="<?php echo get_settings('home'); ?>" title="Volver a la p&aacute;gina principal"><?php bloginfo('name'); ?> </a>
                 </div>
