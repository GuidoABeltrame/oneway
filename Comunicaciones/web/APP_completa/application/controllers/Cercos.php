...
class Cercos extends CI_Controller {
	...
	function sendEmail( $data ){
                    ...
                    <tr>
                        <td class="column" width="600" colspan="2" align="center" valign="top" style="padding: 10px 20px 20px 20px; font-family: arial,sans-serif; font-size: 14px; line-height: 18px; color: #000001;">
							<p>Contacto enviado desde <br> 
								<a href="http://www.aysalarmas.com/" style="color:rgb(79,79,79);text-decoration:none">www.aysalarmas.com.ar</a>
							</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="column" width="600" colspan="2" align="center" valign="top" style="padding: 10px 20px 20px 20px; font-family: arial,sans-serif; font-size: 14px; line-height: 18px; color: #000001;">
                            ...
                            <p style="font-size:12px">'.$data['range'].'</p>';
		...
		$headers .= "From: Contacto AyS <soluciones@aysalarmas.com.ar>\r\n";
