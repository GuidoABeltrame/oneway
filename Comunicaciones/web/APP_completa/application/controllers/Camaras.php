...
class Camaras extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view('camaras/main_view',$data);
	...
	function sendContact(){
		...
		$data = array(
			...
			'opt' => $this->input->post('opt_camara')
		);
		...
		$html = '<!DOCTYPE html>
            ...
            <body>
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td class="column" width="600" colspan="2" align="center" valign="top" style="padding: 10px 20px 20px 20px; font-family: arial,sans-serif; font-size: 14px; line-height: 18px; color: #000001;">
                            <h2 style="border: 0;">Información de contacto | Camaras</h2>
                            <p style="font-size:12px">Nombre: '.$data['name'].'</p>
                            <p style="font-size:12px">Correo: '.$data['mail'].'</p>
                            <p style="font-size:12px">Teléfono: '.$data['tel'].'</p>
                            <p style="font-size:12px">Información: '.$data['opt'].'</p>';
